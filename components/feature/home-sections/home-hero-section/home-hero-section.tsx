...
export const HomeHeroSection = () => {
    return <section className="bg-[#F6F3F3] py-[50px] text-center">
        <div className="container mx-auto px-5">
            ...
            <div className="flex mt-4 gap-4 justify-center">
                <button
                    className="h-12 flex justify-center items-center bg-primary-1 font-semibold text-black-111 rounded-xl py-3 px-6">
                    Explore Now
                </button>
                <button
                    className="h-12 flex justify-center items-center border-black text-black border font-semibold rounded-xl py-3 px-6">
                    Learn More
                </button>
            </div>
