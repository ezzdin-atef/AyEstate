    ...
    <section className="bg-black py-[50px] text-white">
      <div className="container mx-auto px-5">
        <div className="mb-12 grid-cols-2 gap-10 lg:grid">
          <div>
            <h4 className="mb-3 text-base font-semibold lg:mb-4">Innovative</h4>
            <h2 className="mb-5 text-[32px] font-bold leading-10 lg:max-w-2xl lg:text-[48px] lg:leading-[58px]">
